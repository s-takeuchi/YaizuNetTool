...
void MyMsgProc::AddMsg()
{
	...
	MessageProc::AddEng(SFW_140_150_4, _T("A bug fixed that the redundant logs regarding socket closing are generated by same receiver element when threads are stopping."));
